...
export default function ChatInterface() {
  ...
  const mentors: Mentor[] = [
    {
      ...
      studentsHelped: 342,
      rating: 4.9,
      tagline: 'Ask me about tech careers',
    ...
    },
    {
      ...
      studentsHelped: 189,
      rating: 4.8,
      tagline: 'Finance career guidance',
  ...
  const universities: University[] = [
    ...
    },
    {
      ...
      shortName: 'Harvard',
      specialty: 'Business & Liberal Arts',
      studentsHelped: 1103,
      rating: 4.9,
      tagline: 'Application guidance',
    ...
    },
    {
      ...
      shortName: 'Yale',
      specialty: 'Law & Medicine',
      studentsHelped: 534,
      rating: 4.8,
      tagline: 'Yale admissions help',
      responseTime: 'Quick response',
    },
    {
      id: '6',
  ...
  const successStories: SuccessStory[] = [
    {
      id: '1',
      text: 'Got into Stanford CS after chatting with AI advisors',
      author: 'Emma S.',
      school: 'Stanford',
    },
    {
      id: '2',
      text: 'Landed my dream internship at Google with mentor guidance',
      author: 'David L.',
      school: 'MIT',
    },
    {
      id: '3',
      text: 'Changed my major and found my passion through AI conversations',
      author: 'Sophie M.',
      school: 'Harvard',
    },
  ];
                    ...
                    <DropdownMenu>
                      ...
                      >
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            setInputMessage(
                              'I need help shortlisting universities based on my profile'
                            );
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            setInputMessage(
                              'Can you recommend mentors who can guide me?'
                            );
                            setTimeout(() => handleSendMessage(), 100);
                          }}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            setInputMessage(
                              'Help me find the best courses for my career goals'
                            );
                            setTimeout(() => handleSendMessage(), 100);
                          }}
                        >
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            setInputMessage(
                              'Which countries are best suited for my profile and goals?'
                            );
                            setTimeout(() => handleSendMessage(), 100);
                          }}
                        >
              ...
              <div className="mt-8 max-w-[800px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <button
                    onClick={() => {
                      setInputMessage(
                        'What are the best universities for Computer Science in the US?'
                      );
                      setTimeout(() => handleSendMessage(), 100);
                    }}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm font-medium">
                        What are the best universities for Computer Science in
                        the US?
                      </span>
                    </div>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      setInputMessage(
                        'Help me prepare for my Stanford CS interview'
                      );
                      setTimeout(() => handleSendMessage(), 100);
                    }}
                    className="group relative px-4 py-3 text-left rounded-lg border border-border/50 hover:border-primary/50 bg-card/50 backdrop-blur-sm transition-all hover:shadow-lg hover:scale-[1.02]"
                  ...
                  <button
                    onClick={() => {
                      setInputMessage(
                        'I need guidance on writing a compelling SOP for grad school'
                      );
                      setTimeout(() => handleSendMessage(), 100);
                    }}
                    className="group relative px-4 py-3 text-left rounded-lg border border-border/50 hover:border-primary/50 bg-card/50 backdrop-blur-sm transition-all hover:shadow-lg hover:scale-[1.02]"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm font-medium">
                        I need guidance on writing a compelling SOP for grad
                        school
                      </span>
                    </div>
                  </button>
                  ...
                  <button
                    onClick={() => {
                      setInputMessage(
                        "What's the typical timeline for applying to US universities?"
                      );
                      setTimeout(() => handleSendMessage(), 100);
                    }}
                    className="group relative px-4 py-3 text-left rounded-lg border border-border/50 hover:border-primary/50 bg-card/50 backdrop-blur-sm transition-all hover:shadow-lg hover:scale-[1.02]"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm font-medium">
                        What's the typical timeline for applying to US
                        universities?
                      </span>
                    </div>
                  </button>
              ...
              <div className="space-y-6">
                <div className="text-center mb-8">
                  <p className="text-lg text-muted-foreground">
                    Maya is your AI-powered career counselor, specialized in
                    helping students navigate their study abroad journey.
                  </p>
                </div>
                ...
                <div className="grid gap-4">
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">
                        University Research & Matching
                      </h3>
                      <p className="text-sm text-muted-foreground">
                        Get personalized university recommendations based on
                        your profile, budget, and aspirations. Compare programs,
                  ...
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Craft compelling SOPs, essays, and cover letters. Get
                        feedback on your documents and tips for making your
                  ...
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Stay on track with personalized timelines, important
                        deadlines, and reminders for applications, tests, and
                        visa processes.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Practice with mock interviews, get tips on common
                        questions, and build confidence for your university
                        interviews.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Explore career paths, understand job markets, and get
                        advice on building skills that align with your goals.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-4 rounded-lg bg-secondary/50">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Connect with students who've been through similar
                        journeys and get insights from their experiences.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 p-4 rounded-lg bg-primary/5 border border-primary/20">
                  <p className="text-sm text-center">
                    <span className="font-semibold">💡 Pro tip:</span> Maya
                    remembers your preferences and goals from onboarding to
                    provide personalized advice throughout your journey.
                  </p>
                </div>
              </div>
            </ScrollArea>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-lg bg-secondary/50">
                    ...
                    <p className="mt-1 font-medium">
                      {userProfile?.currentEducation || 'Not set'}
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-lg bg-secondary/50">
                    ...
                    <p className="mt-1 font-medium">
                      {userProfile?.studyTimeline || 'Not set'}
                    </p>
                  </div>
                  ...
                  <div className="p-4 rounded-lg bg-secondary/50">
                    ...
                    <p className="mt-1 font-medium">
                      {userProfile?.preferredCourse || 'Not set'}
                    </p>
                  </div>
                ...
                <div className="mt-8 p-4 rounded-lg bg-primary/5 border border-primary/20">
                  <p className="text-sm text-center">
                    <span className="font-semibold">🔒 Privacy:</span> This
                    information helps Maya provide personalized guidance. Your
